...
public class WebServiceConfig extends WsConfigurerAdapter{
	...
	@Bean
	public ServletRegistrationBean messageServletDispatcher(ApplicationContext applicationContext) {
	...
	@Bean
	public XsdSchema livrariaSchema() {
		return new SimpleXsdSchema(new ClassPathResource("livraria.xsd"));
	}
}
